...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { community_id: @personal.community_id, fullname: @personal.fullname, user_id: @personal.user_id } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { community_id: @personal.community_id, fullname: @personal.fullname, user_id: @personal.user_id } }
