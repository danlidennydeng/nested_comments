...
class ComplainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complain" do
    assert_difference('Complain.count') do
      post complains_url, params: { complain: { content: @complain.content, micropost_id: @complain.micropost_id } }
    end
  ...
  test "should update complain" do
    patch complain_url(@complain), params: { complain: { content: @complain.content, micropost_id: @complain.micropost_id } }
